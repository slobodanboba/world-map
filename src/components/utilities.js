...
export const  instagramApi = () => {
    async function fetchTempC() {
       // https://api.instagram.com/oauth/authorize/?client_id=CLIENT-ID&redirect_uri=REDIRECT-URI&response_type=token
        const response = await fetch(`https://api.instagram.com/v1/media/search?lat=48.858844&lng=2.294351&access_token=256864373.0967294.403d6bf2556f4cb9bc78cda8b4e3a958`);
...
// https://api.instagram.com/v1/locations/6889842/media/recent?access_token=256864373.0967294.403d6bf2556f4cb9bc78cda8b4e3a958
